          ...
          <div className="hidden md:flex items-center space-x-8 text-sm font-bold relative z-10">
            {[
              ...
              >
                ...
                <span
                  className={`absolute -bottom-1 left-0 h-[2px] bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 transition-all duration-500 ease-out shadow-[0_0_15px_rgba(147,51,234,0.8)] ${
          ...
          <div className="flex items-center space-x-3 relative z-10">
            ...
            >
              ...
              <div className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                <div
                  className="absolute inset-0 rounded-full border-2 border-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-border animate-spin-slow"
